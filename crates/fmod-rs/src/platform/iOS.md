...
## iOS Specific Starter Guide
 ...
 FMOD is compiled using the following tools.
  ...
  - **Xcode** - version 14.0.1 targeting SDK 16.0.
 
 ### Compatibility

 FMOD supports devices of the below architectures back to iOS / tvOS 11.0. Please note that armv6, armv7, armv7s and x86 are no longer supported by Xcode and thus are no longer supported by FMOD.

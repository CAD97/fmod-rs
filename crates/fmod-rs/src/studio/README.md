...
<!-- This markdown is generated by docgen. Do not edit by hand. -->
 ...
 If using the C# wrapper you will need to call a Core API function before calling anything else in the Studio API. Some runtimes do not perform dependency loading, and because the Studio API depends on the Core API, fmod.dll needs to be loaded before fmod_studio.dll - this can be ensured by calling a Core API function before [`studio::System::new`](studio::System::new "FMOD Studio System creation function.")

 ## Creating the Studio System

 Instances of [`studio::System`](studio::System "") must be created by calling [`studio::System::new`](studio::System::new "FMOD Studio System creation function."). Once created an instance must be initialized with a call to [`studio::System::initialize`](studio::System::initialize "Initializes the Studio System.") before it can be used. [`studio::System::new`](studio::System::new "FMOD Studio System creation function.") also creates an FMOD [`System`](System "") instance which can be retrieved using [`studio::System::getCoreSystem`](studio::System::getCoreSystem "Retrieves the Core System.").
 ...
 For information on using FMOD example code in your own programs, visit https://www.fmod.com/legal
 ...
 **See Also:** [Callback Behavior](<https://fmod.com/resources/documentation-api?version=2.02&page=glossary.html#callback-behavior>)
 ...
 - [`studio::EventInstance::setParameterByNameWithLabel`](studio::EventInstance::setParameterByNameWithLabel "Sets a parameter value by name, looking up the value label.")
 - [`studio::EventInstance::setParameterByID`](studio::EventInstance::setParameterByID "Sets a parameter value by unique identifier.")
 - [`studio::EventInstance::setParameterByIDWithLabel`](studio::EventInstance::setParameterByIDWithLabel "Sets a parameter value by unique identifier, looking up the value label.")
 
 or a global basis:

  - [`studio::System::setParameterByName`](studio::System::setParameterByName "Sets a global parameter value by name.")
 - [`studio::System::setParameterByNameWithLabel`](studio::System::setParameterByNameWithLabel "Sets a global parameter value by name, looking up the value label.")
 - [`studio::System::setParameterByID`](studio::System::setParameterByID "Sets a global parameter value by unique identifier.")
 - [`studio::System::setParameterByIDWithLabel`](studio::System::setParameterByIDWithLabel "Sets a global parameter value by unique identifier, looking up the value label.")
